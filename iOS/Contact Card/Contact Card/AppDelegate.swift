...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    static let moreCardsPurchaseProductIdentifier = "com.MN.moreCards"
    ...
    static weak var showCardCommand:ShowCardCommand?
    ...
    func applicationDidBecomeActive(_ application: UIApplication) {
        ...
        if let currentViewController = self.window?.currentViewController(), LoginViewController.loginCommand == nil {
            LoginCommand(viewController: currentViewController, returnCommand: nil).execute(completed: nil)
        } else {
            LoginViewController.loginCommand?.execute(completed: nil)
        }
    }
    ...
    func applicationDidEnterBackground(_ application: UIApplication) {
        AppDelegate.showCardCommand?.deleteSavedCopy()
    }
